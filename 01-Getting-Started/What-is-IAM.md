...
Identity & Access Management (IAM) is the discipline of creating, managing, securing, and governing digital identities throughout their lifecycle.
...
Identity & Access Management is responsible for:

- Managing digital identities
- Verifying user identities (Authentication)
- Controlling user access (Authorization)
...
- IAM centralizes authentication and access management.
- IAM automates provisioning whenever possible.
- IAM reduces manual administration.
- IAM improves security, consistency, and governance.
